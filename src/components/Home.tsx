...
const Home: React.FC = () => {
  return (
    <div>
      {/* Top Section */}
      <div className="border border-gray-300 bg-[#106cb8] bg-gradient-to-r from-black/60 to-transparent rounded-b-full shadow-md h-[250px] text-white mb-5">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex justify-around mb-5">
          ...
          <div className="bg-whitesmoke rounded-lg p-2 flex flex-col items-center">
            <FaShoppingCart className="text-black" size={30} /> {/* You can adjust the size and color as needed */}
            <span className="ml-2">All Stock</span> {/* Added margin to separate the icon and text */}
          </div>
          <div className="bg-whitesmoke rounded-lg p-2 flex flex-col items-center">
      ...
      {/* Bottom Navigation */}
      <ul className="flex justify-evenly bg-[#106cb8] bg-gradient-to-r from-black/60 to-transparent rounded-lg shadow-lg p-2">
        <li>
